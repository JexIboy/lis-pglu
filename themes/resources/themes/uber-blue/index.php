...
<body>
    <?php if(Yii::app()->user->getState("roles")=='SYSAD'){
 include('/themes/resources/themes/uber-blue/addAlbum.php'); 
} 
?>
...
<div id="galleryWrapper">
    ...
    <h3 id="galleryH1">Gallery</h3>
    
    <?php if( Yii::app()->user->getState("roles")=='SYSAD'){ ?>
    <button type="button" class="btn btn-primary" id="uploadButton">Add Photos</button>
