<?php $x=CommMeetingOrdi::model()->findByPK($model->meeting_ordi_id); ?>
...
$this->menu=array(
	...
	array('label'=>'Update Committee Meeting', 'url'=>array('update', 'id'=>$model->meeting_ordi_id)),
	array('label'=>'Delete Committee Meeting', 'url'=>'#','visible'=> $role=='SYSAD'? true:false, 'linkOptions'=>array('submit'=>array('delete','id'=>$model->meeting_ordi_id),'confirm'=>'Are you sure you want to delete this item?')),
...
$box = $this->beginWidget ( 'bootstrap.widgets.TbBox', array (
		'title' => 'View Committee Meeting # '.$x->meeting_ordi_id,
		...
		'headerButtons' => array(
				array('class' => 'bootstrap.widgets.TbButton',
					   'type' => 'primary',
					  'label' => 'Assign Date of Committee Report',
					  'disabled' => $act,
					  'htmlOptions' => array(
					  			'id'=>'modalButton',
            					'data-toggle' => 'modal',
...
$this->widget('bootstrap.widgets.TbDetailView', array(
    ...
    'attributes'=>array(
		...
		'public_hearing',
		'comm_report',
		array('name'=>'comm_rep_file','type'=>'raw','value'=>CHtml::link($model->comm_rep_file,array("commMeetingOrdi/download","id"=>$model->meeting_ordi_id))),
    ),
));
?>
</div>
