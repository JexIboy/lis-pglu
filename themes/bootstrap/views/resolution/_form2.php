...
$box = $this->beginWidget ( 'bootstrap.widgets.TbBox', array (
		'title' => $model->isNewRecord ? 'Add Old Resolution' : 'Update Resolution'.' # '.$model->res_no ,
...
?>
	...
	<?php echo $form->textFieldRow($model,'res_no',array('class'=>'span2',  'value'=>'', 'placeholder'=>'000 - 0000')); ?>
   
	<?php echo $form->textAreaRow($model, 'subj_matter', array('class'=>'span6', 'rows'=>5,'value'=>'' , 'placeholder'=>'Please check the spacing in Resolution Number :)')); ?> 
