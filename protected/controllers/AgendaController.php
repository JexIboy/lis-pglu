	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('index','view','create','update','admin','ViewTypeComm','XUrgentComm','UrgentComm'),
				'roles'=>array('SCR-RC'),
			),
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('index','view','delete','update','admin','ViewTypeComm','create','XUrgentComm','UrgentComm'),
				'roles'=>array('SYSAD'),
			),
