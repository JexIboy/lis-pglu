...
class TCPDF {
	 ...
	 * It is automatically calledftitle by AddPage() and could be overwritten in your own inherited class.
	 * @public
	 */
	...
	public function Header() {
		...
		$this->Write(0,$this->title, '', 0, 'C', true, 0, false, false, 0);
    ...
    $tbl .='</tr>';
    $tbl .='<tr>
    		<td style="text-align:left; height:10px;"><u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</u></td>';
    $tbl .='</tr>';
    $tbl .='<tr>
    		<td style=""></td>';
    $tbl .='</tr>';
    	$tbl .='<tr>
    		<td style="text-align:left;">Generated By: <b>'.$this->author.'</b> </td>';
    $tbl .='</tr>';
    $tbl .='<tr>

    		<td style="text-align:left;">Date Generated: '.date('F d, Y h:i:s A').' </td>';
    $tbl .='</tr>';
    
    $tbl .='<tr>
    		<td style="text-align:left;">Page'.$this->getAliasNumPage().'/'.$this->getAliasNbPages().' </td>';
    $tbl .='</tr>';
    $tbl .='</table></div>';
