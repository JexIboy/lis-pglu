...
<div class="container" id="page"  >
    ...
    'label'=>$receiving, 
        ...
        $rfTotal=0;
        $rfTotal=$referralCount+$meetingOrdiCount+$meetingResoCount;
    ...
    array(
                    ...
                    'items'=>array(
                            ...
                            array('label'=>'Login', 'url'=>array('/site/login'), 'visible'=>Yii::app()->user->isGuest),
                            array('label'=>'Logout ('.Yii::app()->user->name.')', 'url'=>array('/site/logout'), 'visible'=>!Yii::app()->user->isGuest),
                            array('label'=>'Notifications '.$notifTtotal,'url'=>array('#'),'icon'=>'icon-bell icon-white','items'=>array(array('label'=>'For Ordinance '.$notifTordi,'url'=>array('/resolution/resolutionList')),
                                                                                                                                        array('label'=>'For Resolution '.$notifTreso,'url'=>array('/ordinance/ordinanceList')),
                                                                    )),
                    ),
            ),
        )
    ...
    array(
            ...
            array(
                ...
                array('label'=>'Utilities','url'=>array('#'),'items'=>array(array('label'=>'Audit Trails','url'=>array('/auditTrails/index')),
                                                                        array('label'=>'User Maintenance','url'=>array('/user/index')),
                                                                        array('label'=>'System Backup','url'=>array('/utilities/sysBackUp')),
                                                                    )),
                array('label'=>'Reports','url'=>array('#'),'items'=>array(array('label'=>'Resolution Reports','url'=>array('/reportsresolution/index')),
                                                                          array('label'=>'Ordinance Reports','url'=>array('/reportsordinance/index')),
                                                                          array('label'=>'Other Reports','url'=>array('/reportsOthers/commReportMonthly')),
    ...
    array(
                    ...
                    'items'=>array(
                            ...
                            array('label'=>'Login', 'url'=>array('/site/login'), 'visible'=>Yii::app()->user->isGuest),
                            array('label'=>'Logout ('.Yii::app()->user->name.')', 'url'=>array('/site/logout'), 'visible'=>!Yii::app()->user->isGuest),
                            array('label'=>'Notifications '.$notif,'url'=>array('#'),'icon'=>'icon-bell icon-white','items'=>array(array('label'=>'Unposted Topics '.$notif,'url'=>array('/ForumQuestion/confirmTopic')),
                                                                         // array('label'=>'Ordinance Reports','url'=>array('/reportsordinance/index')),
                                                                          //array('label'=>'Other Reports','url'=>array('/reportsOthers/commReportMonthly')),
                                                                    )),
                    ),
